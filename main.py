...
# Make the OpenCV window resizable and large
cv2.namedWindow("Object Detection - Webcam (Optimized)", cv2.WINDOW_NORMAL)
cv2.resizeWindow("Object Detection - Webcam (Optimized)", 1280, 720)  # You can increase this to 1920x1080 if needed
cv2.moveWindow("Object Detection - Webcam (Optimized)", 0, 0)
